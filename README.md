...
```javascript
FLOAT16_EXPONENT_MASK = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-exponent-mask@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float16-exponent-mask/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float16-exponent-mask/actions/workflows/test.yml?query=branch:v0.1.0
